"use client"
/**
 * Bu bileşen, alışveriş sepetinin özetini gösterir.
 * Sepetin ara toplamını, kargo ücretini ve sipariş toplamını içerir.
 * Ayrıca, "Sepeti Onayla" butonu aracılığıyla ödeme işlemi başlatılabilir.
 */
  ...
  return (
    ...
    >
      ...
      <dl className="mt-6 space-y-4">
        ...
        <div className="flex items-center justify-between border-t border-gray-200 pt-4 dark:border-gray-600">
          <dt className="text-base font-medium">Sipariş Toplamı</dt>
      ...
      <div className="mt-6">
        <Button onClick={onCheckout} className="w-full" disabled={isDisabled}>
          ...
          {isLoading ? "Yükleniyor..." : "Sepeti Onayla"}
        </Button>
      </div>
    </section>
  )
