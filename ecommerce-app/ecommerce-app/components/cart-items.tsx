"use client"
/**
 * Bu bileşen, alışveriş sepetinde bulunan ürünleri listeler.
 * Her ürün için ürün bilgilerini, fiyatını, bedenini ve miktarını gösterir.
 * Ayrıca her ürün için kaldırma işlemi yapılabilir.
 */
        ...
        <li key={product._id} className="flex py-6 sm:py-10">
          ...
          <div className="ml-4 flex flex-1 flex-col justify-between sm:ml-6">
            ...
            <p className="mt-4 flex space-x-2 text-sm">
              ...
              <span>1 hafta içinde kargoya verilir</span>
            </p>
          </div>
        </li>
      ))}
